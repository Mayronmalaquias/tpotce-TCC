"""
Classificador de ataques para o honeypot Dionaea (SMB/FTP/MSSQL/MQTT/TFTP/...).

Entrada : ../../data/dataset/dionaea_training_features.csv
           (gerado por data_pipeline/build_dionaea_dataset.py)

Saidas  : models/dionaea_<modelo>.joblib        - modelo treinado
          models/dionaea_<modelo>_meta.json     - metadados e metricas
...
DATASET_PATH = "../../data/dataset/dionaea_training_features.csv"
MODELS_DIR   = Path("models")

# Features extraidas pelo data_pipeline/extract_dionaea_features.py
FEATURE_COLS = [
    "connection_count",
    "unique_ports",
    "unique_protocols",
...
def train(dataset_path: str, model_type: str = "rf", seed: int = 42) -> None:
    ...
    if not csv_path.exists():
        ...
        print("Execute primeiro: cd data_pipeline && python build_dionaea_dataset.py", file=sys.stderr)
        sys.exit(1)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Treina classificador de ataques para o Dionaea"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Caminho do CSV de features (padrao: ../../data/dataset/dionaea_training_features.csv)"
    )
    parser.add_argument(
